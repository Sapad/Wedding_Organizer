...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="<?= base_url('assets/landing')?>/img/20240615_1640991229.png" />
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-1" href="<?= base_url('admin/Dashboard'); ?>"><img src="<?= base_url('assets/landing')?>/img/20240615_1640991229.png" class="mr-1" alt="logo"/> JeWePe WO</a>
        <a class="navbar-brand brand-logo-mini" href="<?= base_url('admin/Dashboard'); ?>"><img src="<?= base_url('assets/landing')?>/img/20240615_1640991229.png" alt="logo"/></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php $this->load->view($page);?>
          ...
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021. JeWePe WO 2024</span>
          </div>
        </footer> 
        <!-- partial -->
      </div>
